...
import { HandCoins, Mail, Eye, EyeOff, Loader2 } from 'lucide-react';
...
const ResetPassword = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-zinc-900 to-zinc-800 flex items-center justify-center p-2.5">
            <div onClick={() => navigate('/')} className="cursor-pointer absolute left-4 md:left-14 lg:left-72 top-8 flex items-center gap-2 sm:gap-3">
                        ...
                        <form onSubmit={handleSendOtp} className="space-y-4">
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-3 bg-zinc-700 rounded-lg text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-indigo-400"
                                    required
                                />
                            </div>
                            <button
