        ...
        >
            <div className="bg-white p-8 rounded-lg shadow-lg max-w-lg w-full text-center">
                ...
                <p className="text-lg text-gray-600 mb-6">
                    You are just one step away from verifying your account. Please confirm
                ...
                <p className="text-sm text-gray-500 mt-2">
                    Need help? Feel free to reach out to our support team at{" "}
                    <a href="mailto:teamSupport@gmail.com" className="text-blue-600">
                        teamSupport@gmail.com
                    </a>
                </p>
            </div>
        </div>
